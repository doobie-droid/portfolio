<template>
    <li class="relative border-0 md:border-t-2">
        <span
            class="absolute transform -translate-y-1/2 w-full md:w-16 h-12 flex justify-center md:justify-start items-center bg-white  dark:bg-neutral-900">
            <span class="p-2 bg-primary dark:bg-yellow-400 rounded-full flex justify-center items-center">
                <svg fill="currentColor" class="h-6 w-6 text-white dark:text-black" viewBox="0 0 50 50"
